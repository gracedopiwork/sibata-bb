...
<head>
    ...
    <title>{{ $unit->unit_code }} — SIBATA-BB Kejari Wajo</title>
...
<body class="min-h-screen bg-parchment">
    <div class="mx-auto max-w-lg px-4 py-10">
        <img src="{{ asset('images/logo-sitaba-bb.png') }}" alt="Logo SIBATA-BB" class="mb-4 h-16 w-16 rounded-full bg-white object-cover ring-1 ring-gold-500/40">
