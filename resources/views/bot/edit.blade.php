...
@section('heading', 'Bot Telegram SITABA-BB')
...
<div class="grid gap-6 xl:grid-cols-2">
    <div class="card">
        ...
        <ol class="mt-4 list-decimal space-y-2 pl-5 text-sm text-navy-800">
            ...
            <li>Nama tampilan: <b>SITABA-BB Kejari Wajo</b>.</li>
            <li>Username: misalnya <b>SitabaWajoBot</b> (wajib berakhiran <code class="font-mono text-xs">bot</code>).</li>
    ...
    <div class="card">
        ...
        @if ($profile)
            <p class="mt-3 rounded-xl bg-emerald-50 px-3 py-2 text-sm text-emerald-800">
                Tersambung: <b>{{ $profile['first_name'] ?? 'SITABA-BB' }}</b>
