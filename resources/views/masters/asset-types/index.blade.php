...
@section('heading', 'Data Master Jenis Aset')
@section('subheading', 'Klasifikasi aset barang bukti: bergerak, tidak bergerak, keuangan, dan lainnya')

@section('content')
<div class="grid gap-6 lg:grid-cols-3">
    <div class="card">
        <h3 class="font-serif text-lg">Tambah jenis aset</h3>
        <form method="POST" action="{{ route('asset-types.store') }}" class="mt-4 space-y-3">
            @csrf
            <div>
            ...
            <div>
                ...
                <input class="field font-mono uppercase" name="code" value="{{ old('code') }}" placeholder="BERGERAK">
            </div>
                ...
                @foreach ($types as $type)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right">
                            <a class="font-semibold text-navy-800" href="{{ route('asset-types.edit', $type) }}">Ubah</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
