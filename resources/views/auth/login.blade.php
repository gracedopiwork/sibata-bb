...
<div class="relative min-h-screen overflow-hidden">
    ...
    <div class="relative mx-auto grid min-h-screen max-w-6xl items-center gap-10 px-6 py-12 lg:grid-cols-2">
        <div>
            <img src="{{ asset('images/logo-sitaba-bb.svg') }}" alt="Logo SITABA-BB" class="h-36 w-36 rounded-full ring-1 ring-gold-500/40 shadow-2xl">
        ...
        <div class="rounded-3xl border border-white/10 bg-white p-8 text-navy-900 shadow-2xl">
            ...
            <p class="mt-1 text-sm text-navy-600">Hanya administrator. Petugas gudang memakai bot Telegram dengan kode lisensi dari menu Pengguna.</p>
